...
+ fix the bug where simulated player try to destroy liquid blocks
+ fix the bug where behavior of comand and gui was inconsistent when list sp and group
...
+ Now SimPlayer has same gamemode as his creator while creating

### Fixed

+ Fixed SimPlayer loading range issue
