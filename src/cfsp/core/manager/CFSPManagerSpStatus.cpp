...
#define SP_STATUS_DEF(FUNC, ACTION)                                                                                    \
    base::OperateResult                                                                                                \
        CFSPManager::sp##FUNC(Player* player, std::string const& spname, std::optional<bool> enabled, bool nocheck) {  \
...
SP_STATUS_DEF(Sneaking, sneaking)
SP_STATUS_DEF(Swimming, swimming)
SP_STATUS_DEF(Flying, flying)
SP_STATUS_DEF(Sprinting, sprinting)
} // namespace coral_fans::cfsp::manager