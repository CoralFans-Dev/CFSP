...
void PublicGroupListPage::sendTo(Player& player) {
    using ll::i18n_literals::operator""_tr;
    auto form = ll::form::SimpleForm("gui.publicGroupList.title"_tr());
    for (auto groupName : manager::CFSPManager::getInstance().getPublicGroupNamesSorted()) {
